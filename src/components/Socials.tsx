...
export const Browser = ({
  ...
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className={cn(iconStyle, background, foreground, `p-2`)}
  >
...
const Social = ({ link, color }: { link: string; color?: Color }) => {
  ...
  else return <Browser background={color?.background ?? "bg-gray-500"} foreground={color?.foreground ?? "text-white"} />;
};
